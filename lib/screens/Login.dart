...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      resizeToAvoidBottomInset: true, // ✅ Allows content to move up
      body: SafeArea(
        child: LayoutBuilder(
                ...
                child: IntrinsicHeight(
                  child: Column(
                    ...
                    children: [
                      Flexible(
                        child: Image.network(
                          'https://images.unsplash.com/photo-1571388072750-31a921b3d900?ixlib=rb-4.1.0&auto=format&fit=crop&q=80&w=1325',
